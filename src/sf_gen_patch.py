...
def opensrc_model_apr(apr_info):
    ...
    for bug_name in dataset:
        ...
        print(f'buggy_token_len: {buggy_token_len}')
        print(f'curr_max_new_token: {curr_max_new_token}')
                ...
                while len(suggest_patch) < 5:
                    try:
                        ...
                        for _, output in enumerate(outputs):
                            ...
                            # Print the generated patch in the terminal
                            print(f"Generated patch for bug '{bug_name}':\n{fixed_result}")
